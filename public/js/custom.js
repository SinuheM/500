...
jQuery(document).ready(function() {
   ...
   setInterval(function(){
      var height = $( window ).height() - $('.mainpanel .headerbar').height() - $('.mainpanel .pageheader').height() - 40;

      if($('.subheaderbar').is(':visible')){
         height = height - $('.subheaderbar').height();
      }

      $('.mainpanel .contentpanel').css('max-height', height);
   }, 100);
